		...
		function makeWaypointScroll(obj) {
			...
			if (!isNoviBuilder) {
				$this.on('click', function (e) {
					...
					fixedHdrHeight = $(".rd-navbar-panel").outerHeight();
					if ($(this).attr('data-custom-scroll-to') !== "home" && $(window).scrollTop() === 0  && $("html").hasClass("rd-navbar-sidebar-linked")) {
						fixedHdrHeight = fixedHdrHeight / 2 - 3;
					}
						
					$('.rd-navbar-nav-wrap').removeClass('active');		
					$('.rd-navbar-toggle').removeClass('active');
					$("body, html").stop().animate({
						scrollTop: $("#" + $(this).attr('data-custom-scroll-to')).offset().top - fixedHdrHeight
					}, 1000, function () {
						$window.trigger("resize");
					});
				});
